...
{
    public class RepositoryBase<T, TId> : IAsyncRepository<T, TId> where T : BaseDomainModel<TId>
    {
        protected readonly BDJoinDbContext _context;

        public RepositoryBase(BDJoinDbContext context)
        {
            _context = context;
        }
        ...
        public async void UpdateEntity(T entity)
        {
            _context.Set<T>().Attach(entity);
            _context.Entry(entity).State = EntityState.Modified;
        }
