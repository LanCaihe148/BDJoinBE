...
using BDJoinSN.Application.Features.FriendRequests.Queries.GetPendingRequests;
...
namespace BDJoinSN.API.Controllers
{
    ...
    public class FriendController : ControllerBase
    {
        ...
        [HttpGet("pending")]
        [ProducesResponseType(typeof(PaginatedResult<PendingFriendRequestDto>), StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        public async Task<ActionResult<PaginatedResult<PendingFriendRequestDto>>> GetPendingRequests(
            [FromQuery] int pageIndex = 1,
            [FromQuery] int pageSize = 10)
        {
            try
            {
                ...
                var query = new GetPendingRequestQuery
                {
                    UserId = userId,
                    PageIndex = pageIndex,
                    PageSize = pageSize
